...
package com.bourre.log 
{
	...
	public class Logger
	{
		static private var _oI : Logger = null;
		
		private var _oCB 	: ChannelBroadcaster;
		private var _oLevel : LogLevel;
		
		public function Logger( access : ConstructorAccess )
		{
		...
		// static methods
		static public function LOG( o : *, level : LogLevel, oChannel : EventChannel = null ) : Boolean
		{
			return Logger.getInstance().log( new LogEvent(level, o ), oChannel );
		}
		
		static public function DEBUG( o : *, oChannel : EventChannel = null ) : Boolean
		{
			return Logger.LOG( o, LogLevel.DEBUG, oChannel  );
		}
		
		static public function INFO( o : *, oChannel : EventChannel = null ) : Boolean
		{
			return Logger.LOG( o, LogLevel.INFO, oChannel  );
		}
		
		static public function WARN( o : *, oChannel : EventChannel = null ) : Boolean
		{
			return Logger.LOG( o, LogLevel.WARN, oChannel );
		}
		
		static public function ERROR( o : *, oChannel : EventChannel = null ) : Boolean
		{
			return Logger.LOG( o, LogLevel.ERROR, oChannel );
		}
		
		static public function FATAL( o : *, oChannel : EventChannel = null ) : Boolean
		{
