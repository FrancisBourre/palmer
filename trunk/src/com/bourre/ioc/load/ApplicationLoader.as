...
package com.bourre.ioc.load 
{
	...
	import com.bourre.ioc.assembler.ChannelListenerExpert;
	import com.bourre.ioc.assembler.ConstructorExpert;
	import com.bourre.ioc.assembler.DefaultApplicationAssembler;
	import com.bourre.ioc.assembler.DefaultDisplayObjectBuilder;
	import com.bourre.ioc.assembler.DisplayObjectBuilder;
	import com.bourre.ioc.assembler.DisplayObjectBuilderEvent;
	import com.bourre.ioc.assembler.DisplayObjectBuilderListener;
	import com.bourre.ioc.assembler.DisplayObjectEvent;
	import com.bourre.ioc.assembler.MethodExpert;
	import com.bourre.ioc.assembler.PropertyExpert;
		...
		implements LoaderListener, DisplayObjectBuilderListener
	{
		...
		public function onLoadError( e : LoaderEvent ) : void
		{
			...
			PalmerDebug.ERROR( e.getErrorMessage() );
		}
