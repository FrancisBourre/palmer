...
package net.pixlib.events 
{
	 ...
	 * @author 	Aigret Axel
	 * 
	 * @see net.pixlib.structures.Dimension
	 */
	public class DimensionEvent extends BasicEvent 
	{
		 ...
		 */
		public function DimensionEvent(type : String, target : Object = null , dimension : Dimension = null, bubbles : Boolean = false, cancelable : Boolean = false )
		{
