...
package com.bourre.model 
{
	...
	public class ModelEvent extends StringEvent 
	{
		 ...
		 */	
		public function ModelEvent(type : String, model : Model = null, name : String = null )
		{
			super( type, model, name );
		}
		
		/**
		 * Returns the model object carried by this event.
		 * 
		 * @return	The model object carried by this event.
		 */
		public function getModel() : Model
		{
			return super.getTarget() as Model;
		}
		
		/**
		 * Returns the model name carried by this event.
		 * 
		 * @return	The model name carried by this event.
		 */
