...
package com.bourre.ioc.assembler.locator
{
	 ...
	 */
	public class Import implements ValueObject
	{
		//--------------------------------------------------------------------
		// Public properties
		//--------------------------------------------------------------------
		 ...
		 * Creates instance.
		 */			
		public function Import(	url : URLRequest, rootRef : String ) 
		{
		...
		{
			return PalmerStringifier.stringify( this ) + "(" + "url:" + url + ", " + "rootRef:" + rootRef + ") ";		}
	}
}