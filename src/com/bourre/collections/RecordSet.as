...
package com.bourre.collections 
{
		...
		implements Iterable
	{		protected var _aColumNames 	: Array;
		...
		public function getItemAt ( n : Number ) : Object
		{
			if ( isEmpty( ) )
			{
				PalmerDebug.WARN( this + ".getItemAt(" + n + ") can't retrieve data, collection is empty." );
				return null;
		...
		{
			return PalmerStringifier.stringify( this ) + 'column[' + getColumnNames( ) + '] values[' + getItems( ) + ']' ; 
		}
	}
}