...
{
	import com.bourre.collections.Queue;
		...
		extends AbstractLoader 
	{
		...
		public function add( loader : Loader, name : String, url : URLRequest = null, context : LoaderContext = null ) : Boolean
		{
			if ( name != null ) 
			{
				...
				{
					PalmerDebug.WARN( this + ".add failed, you passed Loader argument without any url property." );
				}

			} else if( !(loader.getName()) )
			{
				PalmerDebug.WARN( "You passed Loader argument without any name property in " + this + ".add()." );
			}
