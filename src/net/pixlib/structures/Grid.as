...
package net.pixlib.structures 
{
	...
	import net.pixlib.collections.TypedContainer;
	import net.pixlib.collections.WeakCollection;
	import net.pixlib.exceptions.IllegalArgumentException;
	import net.pixlib.exceptions.IndexOutOfBoundsException;
	 ...
	 * @see		net.pixlib.collection.Collection	 * @see		net.pixlib.collection.TypedContainer
	 */
	public class Grid 
		implements Collection, TypedContainer
	{
		 ...
		 * <code>net.pixlib.structures::Grid&lt;String&gt;</code>
		...
		public function toString () : String
		{
			...
			return PalmerStringifier.stringify( this ) + parameter + " [" + _vSize.width + ", " + _vSize.height + "]";
		}
		...
		{
			PalmerDebug.ERROR( this + ".addAll() method is unsupported." );
		...
		{
			PalmerDebug.ERROR( this + ".add() method is unsupported." );
		...
		public function isValidCollection ( c : Collection ) : Boolean
		{
			if( c == null ) 
			{
				PalmerDebug.ERROR( "The passed-in collection is null in " + this );
			...
			else if( getType() != null )
			{
				...
				{
					PalmerDebug.ERROR( "The passed-in collection is not of the same type than " + this );
		...
		public function isValidType ( o : Object ) : Boolean
		{
			if ( getType() != null)
			{
				...
				{
					PalmerDebug.ERROR( o + " has a wrong type for " + this );
					throw new IllegalArgumentException( o + " has a wrong type for " + this ) ;
				}
			}
			else
				return true ;
...
import net.pixlib.structures.Grid;
