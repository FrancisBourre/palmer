...
package net.pixlib.load
{
	...
	public class SoundSWFLoader extends SoundLoader
	{
		...
		static public function getSoundInSWF( d : DisplayObjectContainer , sLinkageId : String) : Sound
		{
			...
			{
				PalmerDebug.ERROR("net.pixlib.media.sound.getSoundInSWF("+sLinkageId+") failed, '" + sLinkageId + "' class can't be found in specified SoundFactory application domain");
				throw new NullPointerException("net.pixlib.media.sound.getSoundInSWF"+sLinkageId+") failed, '" + sLinkageId + "' class can't be found in specified SoundFactory application domain") ;
			}
