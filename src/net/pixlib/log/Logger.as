...
{
	import net.pixlib.events.ChannelBroadcaster;
	 ...
	 *  
	 *  @eventType net.pixlib.log.LogEvent.onLogEVENT
	 */
	[Event(name="onLog", type="net.pixlib.log.LogEvent.onLogEVENT")]
	
	/**
	 *  Dispatched when a clears message is sent.
	 *  
	 *  @eventType net.pixlib.log.LogEvent.onClearEVENT
	 */
	[Event(name="onClear", type="net.pixlib.log.LogEvent.onClearEVENT")]
	...
	public class Logger
	{
		 ...
		 * 
		 * Logger.getInstance().log( evt, PalmerDebug.CHANNEL );
		 * </pre>
		...
		{
			if ( !(access is ConstructorAccess) ) throw new ConstructorAccess();
