...
package net.pixlib.core 
{
	 ...
	 *  
	 *  @eventType net.pixlib.core.LocatorEvent.onRegisterObjectEVENT
	 */
	[Event(name="onRegisterObject", type="net.pixlib.core.LocatorEvent")]

	/**
	 *  Dispatched when an object is unregistered form locator.
	 *  
	 *  @eventType net.pixlib.core.LocatorEvent.onUnregisterObjectEVENT
	 */
	[Event(name="onUnregisterObject", type="net.pixlib.core.LocatorEvent")]
	...
	public class AbstractLocator implements Locator, TypedContainer
	{
		...
		/**
		 * @copy net.pixlib.events.Broadcaster#broadcastEvent()
		 */
